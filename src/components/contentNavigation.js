    ...
    render() {
        return (
            <div className="sidenav">
                ...
                <span role="button" tabIndex="0" class="sidenav-arrow-button" onClick={() => { this.toggleContents(this.state.isOpen); this.setState({ isOpen: !this.state.isOpen }); }}>
                    <span id="sidenav-toggle" class="sidenav-arrow"><span></span><span></span></span>
                </span>
            </div>
        )
    }
